...
def after(**kargs):
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~ new
    if command == 'new':
        os.unlink(os.path.join(app.path, 'app/controllers/Application.java'))
        ...
        shutil.copyfile(os.path.join(module_dir, 'resources', 'controllers', 'application.scala'), os.path.join(app.path, 'app', 'controllers', 'application.scala'))
